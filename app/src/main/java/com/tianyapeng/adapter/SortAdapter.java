...
import com.tianyapeng.handle.ImageLoader;
...
public class SortAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.item_people, null);
            viewHolder.tvHead = (ImageView) view.findViewById(R.id.head_image);
